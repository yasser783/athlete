  ...
  e.respondWith(
    caches.match(e.request).then(cached => {
      ...
      return fetch(e.request).then(res => {
        ...
        // Renvoyer index.html UNIQUEMENT pour les requêtes de navigation (page web)
        // Pas pour les scripts JS, CSS, images — sinon "Script error ligne 0 col 0"
